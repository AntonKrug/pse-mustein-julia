...
/*=========================================================================*//**
  ...
  ==============================================================================
  The PSE microcontroller subsystem (MSS) includes two multi-mode UART
  ...
  this driver with the exception of the PSE IOMUX configuration.
  PSE allows multiple non-concurrent uses of some external pins through
  ...
  PSE device external pins. The MSS MMUART serial signals may also be
  routed through IOMUXs to the PSE FPGA fabric. For more information on
  IOMUX, refer to the IOMUX section of the PSE Microcontroller
  ...
  PSE MSS configurator if you wish to use them. For more information on
  IOMUXs, refer to the IOMUX section of the PSE Microcontroller
  Subsystem (MSS) User�s Guide.
  The base address, register addresses and interrupt number assignment for the
  MSS MMUART peripherals are defined as constants in the PSE CMSIS HAL.
  You must ensure that the latest PSE CMSIS HAL is included in the
  ...
  driver.
  Note: The PSE CMSIS-PAL defines the UART0_IRQHandler() and
...
struct mss_uart_instance{
    ...
    uint8_t                 irqn;       /*!< UART's Interrupt instance- Ca refert to loal or PLIC */
...
/***************************************************************************//**
  The MSS_UART_init() function initializes and configures one of the PSE
