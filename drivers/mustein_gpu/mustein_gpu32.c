...
void MUSTEIN_INLINE mustein_write_high_color_raw16(uint32_t base, uint32_t offset,
        uint16_t value) {
...
void MUSTEIN_INLINE mustein_write_true_color_raw24(uint32_t base, uint32_t offset,
        uint32_t value) {
