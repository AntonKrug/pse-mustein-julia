...
#define MUSEIN_INLINE __attribute__((always_inline)) inline
#define MUSEIN_OPTIMISE __attribute__((optimize("O3")))
#else
#define MUSEIN_INLINE
#define MUSEIN_OPTIMISE
#endif
...
typedef enum {
	PACKING_SINGLE_PIXEL_PER_WRITE = 1,
	PACKING_FULLY_32bit            = 2,
	PACKING_FULLY_64bit            = 3
} PixelPacking;
