 ...
 *
 * SVN $Revision: 10605 $
 * SVN $Date: 2018-11-26 10:58:46 +0000 (Mon, 26 Nov 2018) $
 */
#ifndef MSS_SYSREG_H
#define MSS_SYSREG_H
...
#define MAINTENANCE_INT_SR_OFFSET   0x148
    /* Indicates that one off the PLLs when into the lock or unlock state. Cleared via PLL event register*/
...
#define mssio_bank4_io_cfg_0_cr_OFFSET   0x234
    /* */
    #define mssio_bank4_io_cfg_0_cr_io_cfg_0_OFFSET  0x0
    #define mssio_bank4_io_cfg_0_cr_io_cfg_0_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank4_io_cfg_1_cr_OFFSET   0x238
    /* */
    #define mssio_bank4_io_cfg_1_cr_io_cfg_2_OFFSET  0x0
    #define mssio_bank4_io_cfg_1_cr_io_cfg_2_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank4_io_cfg_2_cr_OFFSET   0x23C
    /* */
    #define mssio_bank4_io_cfg_2_cr_io_cfg_4_OFFSET  0x0
    #define mssio_bank4_io_cfg_2_cr_io_cfg_4_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank4_io_cfg_3_cr_OFFSET   0x240
    /* */
    #define mssio_bank4_io_cfg_3_cr_io_cfg_6_OFFSET  0x0
    #define mssio_bank4_io_cfg_3_cr_io_cfg_6_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank4_io_cfg_4_cr_OFFSET   0x244
    /* */
    #define mssio_bank4_io_cfg_4_cr_io_cfg_8_OFFSET  0x0
    #define mssio_bank4_io_cfg_4_cr_io_cfg_8_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank4_io_cfg_5_cr_OFFSET   0x248
    /* */
    #define mssio_bank4_io_cfg_5_cr_io_cfg_10_OFFSET  0x0
    #define mssio_bank4_io_cfg_5_cr_io_cfg_10_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank4_io_cfg_6_cr_OFFSET   0x24C
    /* */
    #define mssio_bank4_io_cfg_6_cr_io_cfg_12_OFFSET  0x0
    #define mssio_bank4_io_cfg_6_cr_io_cfg_12_MASK    (0xFFFF << 0x0)
...
#define mssio_bank2_io_cfg_0_cr_OFFSET   0x254
    /* */
    #define mssio_bank2_io_cfg_0_cr_io_cfg_0_OFFSET  0x0
    #define mssio_bank2_io_cfg_0_cr_io_cfg_0_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank2_io_cfg_1_cr_OFFSET   0x258
    /* */
    #define mssio_bank2_io_cfg_1_cr_io_cfg_2_OFFSET  0x0
    #define mssio_bank2_io_cfg_1_cr_io_cfg_2_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank2_io_cfg_2_cr_OFFSET   0x25C
    /* */
    #define mssio_bank2_io_cfg_2_cr_io_cfg_4_OFFSET  0x0
    #define mssio_bank2_io_cfg_2_cr_io_cfg_4_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank2_io_cfg_3_cr_OFFSET   0x260
    /* */
    #define mssio_bank2_io_cfg_3_cr_io_cfg_6_OFFSET  0x0
    #define mssio_bank2_io_cfg_3_cr_io_cfg_6_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank2_io_cfg_4_cr_OFFSET   0x264
    /* */
    #define mssio_bank2_io_cfg_4_cr_io_cfg_8_OFFSET  0x0
    #define mssio_bank2_io_cfg_4_cr_io_cfg_8_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank2_io_cfg_5_cr_OFFSET   0x268
    /* */
    #define mssio_bank2_io_cfg_5_cr_io_cfg_10_OFFSET  0x0
    #define mssio_bank2_io_cfg_5_cr_io_cfg_10_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank2_io_cfg_6_cr_OFFSET   0x26C
    /* */
    #define mssio_bank2_io_cfg_6_cr_io_cfg_12_OFFSET  0x0
    #define mssio_bank2_io_cfg_6_cr_io_cfg_12_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank2_io_cfg_7_cr_OFFSET   0x270
    /* */
    #define mssio_bank2_io_cfg_7_cr_io_cfg_14_OFFSET  0x0
    #define mssio_bank2_io_cfg_7_cr_io_cfg_14_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank2_io_cfg_8_cr_OFFSET   0x274
    /* */
    #define mssio_bank2_io_cfg_8_cr_io_cfg_16_OFFSET  0x0
    #define mssio_bank2_io_cfg_8_cr_io_cfg_16_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank2_io_cfg_9_cr_OFFSET   0x278
    /* */
    #define mssio_bank2_io_cfg_9_cr_io_cfg_18_OFFSET  0x0
    #define mssio_bank2_io_cfg_9_cr_io_cfg_18_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank2_io_cfg_10_cr_OFFSET   0x27C
    /* */
    #define mssio_bank2_io_cfg_10_cr_io_cfg_20_OFFSET  0x0
    #define mssio_bank2_io_cfg_10_cr_io_cfg_20_MASK    (0xFFFF << 0x0)

/*IO electrical configuration for MSSIO pad*/
#define mssio_bank2_io_cfg_11_cr_OFFSET   0x280
    /* */
    #define mssio_bank2_io_cfg_11_cr_io_cfg_22_OFFSET  0x0
    #define mssio_bank2_io_cfg_11_cr_io_cfg_22_MASK    (0xFFFF << 0x0)
...
typedef struct _mss_sysreg
{
    ...
    /*Controls the MSS Corner low power mode signals*/
     __IO uint32_t MSS_LOW_POWER_CR;
    ...
    /* Padding reserved 32-bit registers.*/
     __I uint32_t reservedReg32b_16;
     __I uint32_t reservedReg32b_17;
    ...
    /*IO electrical configuration for MSSIO pad*/
     __IO uint32_t mssio_bank4_io_cfg_0_cr;
    ...
    /* Padding reserved 32-bit registers.*/
     ...
     __I uint32_t reservedReg32b_85;
     __I uint32_t reservedReg32b_86;
    ...
    /* Padding reserved 32-bit registers.*/
     __I uint32_t reservedReg32b_87;
     __I uint32_t reservedReg32b_88;
    ...
    /*Register for ECO usage*/
     __IO uint32_t SPARE_REGISTER_RO;
